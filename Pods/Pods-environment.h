...
// Coinbase
#define COCOAPODS_POD_AVAILABLE_Coinbase
#define COCOAPODS_VERSION_MAJOR_Coinbase 0
#define COCOAPODS_VERSION_MINOR_Coinbase 4
#define COCOAPODS_VERSION_PATCH_Coinbase 0
